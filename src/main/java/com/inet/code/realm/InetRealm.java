...
public class InetRealm extends AuthorizingRealm  {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken) throws AuthenticationException {
        ...
        UserBaseDomain user= (UserBaseDomain) redisTemplate.opsForValue().get(token);
        if (user == null){
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principalCollection) {
        //获取
        UserBaseDomain user= (UserBaseDomain) redisTemplate.opsForValue().get(principalCollection.toString());
